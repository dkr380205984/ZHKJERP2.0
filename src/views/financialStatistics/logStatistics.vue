<template>
  <div id="logStatistics"
    ...
    <div class="bottomFixBar">
      <div class="main">
        <div class="btnCtn">
          <div class="btn btnBlue">导出勾选数据</div>
        </div>
      </div>
    </div>
  </div>
