          ...
          <div class="colCtn"
            ...
            <div class="flexTb">
              ...
              <div class="createModule"
                ...
                <div class="rowCtn">
                  <div class="colCtn flex3">
                    <div class="label">
                      ...
                      <span class="explanation">(选择物料计划后根据物料计划分配产品)</span>
                    </div>
                    <div class="content">
                      <el-select v-model="item.plan_id"
                        filterable
                        @change="getPlanId"
                        placeholder="请选择物料计划">
                ...
                <div class="rowCtn"
                  ...
                  <div class="colCtn flex3">
                    <div class="label"
                      v-if="indexChild===0">
                      <span class="text">产品/配件/尺码/颜色</span>
                      <span class="explanation">(必填)</span>
                    </div>
                    <div class="content">
                      <el-select v-model="itemChild.partColorSize"
                        no-data-text="请先选择产品"
                        placeholder="请选择产品/配件/尺码/颜色">
              ...
              <div class="addRows">
                <span class="once"
                  v-if="!weaving_flag"
                  @click="normalWeaving()">新增计划单分配</span>
                <!-- <span class="once"
                  v-if="!weaving_flag"
