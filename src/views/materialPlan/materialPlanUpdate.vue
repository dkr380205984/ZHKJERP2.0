...
export default {
  ...
  created () {
    Promise.all([
      ...
      planInfo = this.$mergeData(planInfo, { mainRule: ['pid/product_id', 'color_id', 'size_id'], otherRule: [{ name: 'color_name/color' }, { name: 'size_name/size' }], childrenName: 'material_info', childrenRule: { otherRule: [{ name: 'product_id/product_part' }, { name: 'material_name' }, { name: 'material_type/type' }, { name: 'material_attribute/material_color' }, { name: 'single_weight/number' }, { name: 'mix_material_weight/plan_number' }, { name: 'total_weight/total_number' }, { name: 'loss/material_loss' }, { name: 'reality_weight/end_num' }, { name: 'need_weight/need_number' }, { name: 'unit' }] } })
      this.materialPlanInfo.forEach(itemPro => {
