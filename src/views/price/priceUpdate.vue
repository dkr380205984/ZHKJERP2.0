...
<script>
import { priceRemark, getToken, product, client, productType, flower, group, yarn, material, course, price, sample, priceLoading } from '@/assets/js/api'
...
export default {
  ...
  methods: {
    ...
    initEditor () {
      ...
      this.otherRemarkEditor.customConfig.zIndex = 1
      this.otherRemarkEditor.customConfig.onchange = (html) => {
        this.otherRemark = html // 绑定当前逐渐地值
        this.$forceUpdate()
      }
      this.otherRemarkEditor.create()
    }
  },
  mounted () {
    this.initEditor()
