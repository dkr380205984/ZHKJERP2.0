<template>
  <div id='ET'
    ...
    <div class="tableCtn">
      <div class="headerCtn">
        <div class="top">
          <div class="title">{{'桐庐凯瑞针纺'}}货运委托书</div>
        </div>
      </div>
      <div class="bodyCtn">
        <div class="rowCtn">
      ...
      <div class="bodyCtn marginTop"
            ...
            <div class="rowCtn noBorder">
              ...
              <div class="rowItem center">
                <document-input rowModle
                  noLabel
                  innerAlign='center'
                  placeholder='运输方式'></document-input>
              </div>
              ...
              <div class="rowItem center">
                <document-input rowModle
                  noLabel
                  innerAlign='center'
                  placeholder='价格条款'></document-input>
              </div>
            </div>
            <div class="rowCtn">
        ...
        <div class="rowCtn">
          ...
          <div class="rowItem center flex2">
            <document-input rowModle
              noLabel
              placeholder='SHIPPER(收货人)'></document-input>
          </div>
          <div class="rowItem center flex4 col">
            <div class="rowCtn noBorder">
            ...
            <div class="rowCtn noBorder">
              ...
              <div class="rowItem center">
                <document-input rowModle
                  noLabel
                  innerAlign='center'
                  placeholder='贸易国别'></document-input>
              </div>
            </div>
            <div class="rowCtn">
              ...
              <div class="rowItem center">
                <document-input rowModle
                  noLabel
                  innerAlign='center'
                  placeholder='出口口岸'></document-input>
              </div>
              <div class="rowItem center">信用证号</div>
              <div class="rowItem center">
                <document-input rowModle
        ...
        <div class="rowCtn editBtnCtn">
          <div class="addBtn"
            @click="addItem(packerInfo)">添加</div>
        ...
        <div class="rowCtn editBtnCtn"
          ...
          v-for="(itemPack,indexPack) in packerInfo"
          :key="indexPack">
          <div class="deleteBtn iconModle"
            @click="deleteItem(packerInfo,indexPack)"></div>
          <div class="rowItem center">
            <document-input rowModle
              innerAlign='center'
              noLabel
          ...
          <div class="rowItem center"
            ...
            <document-input rowModle
              innerAlign='center'
              noLabel
              placeholder='货品规格'></document-input>
          </div>
          <div class="rowItem center"
            style="flex:0.99">
            <document-input rowModle
              innerAlign='center'
              noLabel
              placeholder='HS CODE'></document-input>
          </div>
          <div class="rowItem center"
            style="flex:0.99">
            <document-input rowModle
